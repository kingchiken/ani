...
if ($received_data->action == 'fetchall') {
    ...
    $query = "SELECT * FROM tbl_samplee ORDER BY id DESC";
...
if ($received_data->action == 'insert') {
    ...
    $query = "INSERT INTO tbl_samplee (first_name, last_name) VALUES (:first_name,
:last_name)";
    $statement = $connect->prepare($query);
...
if ($received_data->action == 'update') {
    ...
    $query = "UPDATE tbl_samplee SET first_name = :first_name, last_name = :last_name WHERE
id = :id";
    $statement = $connect->prepare($query);
    $statement->execute($data);
}
...
if ($received_data->action == 'delete') {
    ...
    $query = "DELETE FROM tbl_samplee WHERE id = :id";
    $statement = $connect->prepare($query);
    $statement->execute($data);
}
